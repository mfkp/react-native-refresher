...
class RefresherListView extends Component {
    constructor() {
        super();
        this.state = {
            threshold: 0,
    ...
    renderIndicator() {
        ...
        let indicatorFunc = function (indicator) {
          return this.refs.indicator = indicator || this.refs.indicator;
        }.bind(this);
        return React.cloneElement(Indicator, {
            // ref: (indicator => {this.refs.indicator = indicator || this.refs.indicator}),
            ref: indicatorFunc(Indicator),
